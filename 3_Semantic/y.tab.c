...
{
       0,    31,    31,    35,    47,    50,    51,    54,    59,    70,
      74,    80,    86,    92,   101,   102,   108,   119,   122,   127,
     136,   143,   154,   157,   168,   171,   172,   173,   174,   175,
     178,   179,   182,   187,   195,   202,   203,   209,   214,   217,
     221,   228,   234,   237,   241,   245,   249,   253,   257,   263,
     269,   272,   276,   282,   288,   291,   295,   300,   301,   302,
     303,   306,   312,   313,   316,   327
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LBRACE", "RBRACE", "LCURLY", "RCURLY", "ERROR", "OTHER", "$accept",
  "program", "declaration_list", "declaration", "var_declaration",
  "type_specifier", "id", "num", "fun_declaration", "params", "param_list",
  "param", "compound_stmt", "local_declaration", "stmt_list", "stmt",
...
{
      40,   -52,   -52,    16,    40,   -52,   -52,    21,   -52,   -52,
     -52,   -52,   -18,   -52,    47,    43,    41,    21,    42,    49,
     -52,   -52,    50,    53,    45,    40,    54,    51,   -52,   -52,
     -52,   -52,   -52,    40,   -52,    21,     4,    13,    56,    57,
      28,   -52,    32,   -52,   -21,   -52,   -52,   -52,   -52,   -52,
     -52,   -52,    60,    63,   -52,    46,    48,   -52,   -52,    32,
      32,   -52,    61,    59,    32,    32,   -52,    32,   -52,   -52,
     -52,   -52,   -52,   -52,   -52,   -52,    32,    32,   -52,   -52,
      32,    62,    64,   -52,   -52,   -52,    65,    68,    58,   -52,
     -52,    52,    48,   -52,    12,    12,   -52,    32,   -52,    71,
     -52,   -52,    12,   -52
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       3,    11,     0,     7,     0,     0,    10,     0,     0,    14,
      17,    12,     0,    18,     0,     0,     0,     0,    22,    13,
      16,     8,    19,    24,    21,     0,     0,     0,     0,     0,
       0,    31,     0,    20,    39,    60,    26,    23,    25,    27,
...
{
     -52,   -52,   -52,    82,    55,    -2,    -6,    77,   -52,   -52,
     -52,    69,    72,   -52,   -52,   -51,   -52,   -52,   -52,   -52,
     -40,   -31,   -52,   -52,    17,   -52,    18,   -52,    19,   -52,
     -52,   -52
};
...
{
      62,    12,    63,    64,    13,    65,    14,    38,    15,    39,
      40,    23,    17,    11,    21,    38,     9,    39,    40,    81,
      82,    11,    21,    17,    85,    88,    41,    89,    42,    37,
      11,    35,    28,    43,    41,    13,    42,    11,    21,    15,
      28,    11,    21,    99,   100,    90,    90,     1,     2,    90,
      61,   103,    42,    21,     1,    16,    42,   101,    68,    69,
      70,    71,    72,    73,    74,    75,   -15,    24,    78,    79,
      74,    75,    25,    28,    67,   102,    31,    26,    32,    27,
      59,    60,    66,    83,    84,    98,    10,    94,    34,    95,
      96,    97,    22,    91,    30,    92,    29,     0,     0,    93
};

static const yytype_int8 yycheck[] =
{
      40,     7,    42,    24,    22,    26,    24,     3,    26,     5,
       6,    17,    14,     9,    10,     3,     0,     5,     6,    59,
      60,     9,    10,    25,    64,    65,    22,    67,    24,    35,
       9,    33,    28,    29,    22,    22,    24,     9,    10,    26,
      28,     9,    10,    94,    95,    76,    77,     7,     8,    80,
      22,   102,    24,    10,     7,     8,    24,    97,    12,    13,
      14,    15,    16,    17,    18,    19,    25,    25,    20,    21,
      18,    19,    23,    28,    11,     4,    22,    27,    27,    26,
      24,    24,    22,    22,    25,    27,     4,    25,    33,    25,
      25,    23,    15,    76,    25,    77,    24,    -1,    -1,    80
};
...
{
       0,     7,     8,    33,    34,    35,    36,    37,    40,     0,
      35,     9,    38,    22,    24,    26,     8,    37,    41,    42,
      43,    10,    39,    38,    25,    23,    27,    26,    28,    44,
      43,    22,    27,    45,    36,    37,    46,    38,     3,     5,
       6,    22,    24,    29,    38,    39,    44,    47,    48,    49,
      50,    51,    52,    53,    54,    56,    58,    60,    61,    24,
      24,    22,    52,    52,    24,    26,    22,    11,    12,    13,
      14,    15,    16,    17,    18,    19,    55,    57,    20,    21,
      59,    52,    52,    22,    25,    52,    62,    63,    52,    52,
      53,    56,    58,    60,    25,    25,    25,    23,    27,    47,
      47,    52,     4,    47
};
...
#line 60 "cminus.y" /* yacc.c:1646  */
    { (yyval) = newExpNode(VarDecK);
                          ...
                          if ((yyvsp[-5])->type == Void)
                              (yyval)->type = VoidArray;
                          else (yyval)->type = IntArray;
						}
